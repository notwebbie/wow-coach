...
struct CharacterSnapshot: Codable, Hashable, Sendable {
    ...
    var knownRecipes: [RecipeSnapshot]?
}

struct QuestSnapshot: Codable, Hashable, Sendable {
    let questID: Int
    let title: String?
    let level: Int?
    let header: String?
...
struct CoachingDashboard: Codable, Hashable, Sendable {
    let recommendedCharacter: String?
    let reason: String?
    let warnings: [String]
    let roster: [CoachingRosterEntry]?
}

struct CoachingRosterEntry: Codable, Hashable, Sendable {
    let character: String
    let rotationPosition: Int?
    let lastUpdatedAt: Date?
    let observedRestedXP: Int?
    let estimatedRestedXP: Int?
    let restedXPIsEstimated: Bool
    let questCount: Int
    let freeBagSlots: Int?
...
struct ReportSummary: Codable, Sendable {
    ...
    let previousReportGeneratedAt: Date?
    let coachingDashboard: CoachingDashboard?
}
