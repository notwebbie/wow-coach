        ...
        NavigationSplitView {
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 22) {
                    ...
                    Text("Questie, GatherMate2, Auctionator, Altoholic, DataStore modules, Pawn, SavedInstances, Bagnon, and Leatrix Lua files. The ZIP includes a readable summary.json plus the original supported files.").foregroundStyle(.secondary)
